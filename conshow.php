...
{
$s=$_REQUEST['scr'];
 $q="select * from iconinfo1 where name='$s'"; 
 $rs=mysqli_query($con,$q);
echo"<table class= 'table table-bordered table-hover table-striped table-responsive-sm'style='margin-top: 40px;'>
    <thead>
      <tr>
        <th colspan=8 class='text-center bg-dark text-light font-weight-bold'>The List Of Contact User's</th>
      </tr>
      <tr>
