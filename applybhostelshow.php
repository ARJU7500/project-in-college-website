...
mysqli_select_db($con,'applyhostel');
if(isset($_REQUEST['serch']))
{
$s=$_REQUEST['scr'];
 $q="select * from hostelstudent where name='$s'"; 
 $rs=mysqli_query($con,$q);
echo"<table class= 'table table-bordered table-hover table-striped table-responsive-sm'style='margin-top: 40px;'>
    <thead>
      <tr>
        <th colspan=14 class='text-center bg-dark text-light font-weight-bold'>The List Of Apply Hostel Student's</th>
      </tr>
      <tr>
