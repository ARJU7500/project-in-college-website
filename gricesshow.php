...
{
$s=$_REQUEST['scr'];
 $q="select * from grvinfo  where name='$s'"; 
 $rs=mysqli_query($con,$q);
echo"<table class= 'table table-bordered table-hover table-striped table-responsive-sm'style='margin-top: 40px;'>
    <thead>
      <tr>
        <th colspan=8 class='text-center bg-dark text-light font-weight-bold'>The List Of Grievances's</th>
      </tr>
      <tr>
    ...
    echo" <tbody>
      <tr>
        ...
        <td><strong>Grievances's</strong></td>
      </tr";
