...
mysqli_select_db($con,'applyghostel');
if(isset($_REQUEST['serch']))
{
$s=$_REQUEST['scr'];
 $q="select * from ghostelstudent where name='$s'"; 
 $rs=mysqli_query($con,$q);
echo"<table class= 'table table-bordered table-hover table-striped table-responsive-sm'style='margin-top: 40px;'>
    <thead>
      <tr>
        <th colspan=14 class='text-center bg-dark text-light font-weight-bold'>The List Of Apply Girl's Hostel Student's</th>
      </tr>
      <tr>
        <th colspan=14 class='text-center bg-light font-weight-bold'>
...
echo" <tr>
        ...
        <td><img src='imgs/$r[13]'height='90'width='150'></td>
        <td>$r[1]</td>
        <td>$r[2]</td>
        <td>$r[3]</td>
        <td>$r[4]</td>
